...
const Projects = () => {
  return (
    <section id="projects" className="projects-section">
        ...
        <ul>
        <li><strong>High-Performance Merkle Tree with CUDA:</strong> Developed and implemented a high-performance GPU-based Merkle Hash Tree library using CUDA and C++, achieving a 70x speed-up over traditional CPU implementations. Refactored NIST SHA-256 Hash Function to leverage parallelism on GPU to optimizing performance.</li>
